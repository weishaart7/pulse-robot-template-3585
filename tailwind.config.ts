...
export default {
	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				'hero-gradient': 'linear-gradient(90deg, hsla(186, 70%, 81%, 1) 0%, hsla(341, 91%, 68%, 1) 100%)',
				'hero-gradient-2': 'linear-gradient(90deg, hsla(186, 70%, 85%, 1) 0%, hsla(186, 70%, 75%, 1) 100%)',
