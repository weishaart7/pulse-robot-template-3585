...
> **État dans `main` au 2026-09-24.** Audit rédigé le 2026-09-01 sur la branche
> `fix/audit-retraite-carriere`, dont les corrections n'ont jamais été fusionnées ; les constats
> ont depuis été retraités directement sur `main`. Les extraits de code et numéros de ligne
> ci-dessous décrivent le code du 2026-09-01, pas le code actuel.
>
> | # | État |
> |---|---|
> | 1, 2 | Corrigés (`f6abf2d`) |
> | 3 | Corrigé (`fa88c7d`) |
> | 4, 12 | Corrigés (`b1c5a67`) |
> | 6, 8 | Corrigés |
> | 11 | Corrigé (`154f9dd`) |
> | 5 | Non calculé par décision du 2026-09-24, signalé à l'écran (cf. `docs/retraite.md`) ; colonnes déclaratives créées en base mais inutilisées |
> | 7 | Ouvert : valeur de référence MIGA 2025 toujours utilisée |
> | 9 | Ouvert : majoration familiale Agirc-Arrco non calculée (critère « nés ou élevés » à trancher) |
> | 10 | Ouvert : plafond d'écrêtement MICO non revalorisé au 1er juin 2026 |
> | 13 | Ouvert (recommandation) : pas d'avertissement pour une date d'effet après 2027 |
