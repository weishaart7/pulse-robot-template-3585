...
| **Assurance emprunteur non exploitée** | `quotite_assuree_*` et `capital_garanti_deces` sont saisis mais n'entrent dans aucun calcul de transmission (le décès n'apure pas le capital restant dû). |
