...
const HeroSection = React.forwardRef<HTMLDivElement, HeroSectionProps>(({
  ...
  return <div className={cn("relative", className)} ref={ref} {...props}>
        ...
        <section className="relative max-w-full mx-auto z-1">
          ...
          <div className="max-w-screen-xl z-10 mx-auto px-4 py-28 gap-12 md:px-8 bg-[#f3f3f3]">
            <div className="space-y-5 max-w-3xl leading-0 lg:leading-5 mx-auto text-center">
              <h1 className="text-sm text-gray-600 group font-geist mx-auto px-5 py-2 bg-gradient-to-tr from-zinc-300/20 via-gray-400/20 to-transparent border-[2px] border-black/5 rounded-md w-fit">
                {title}
                <ChevronRight className="inline w-4 h-4 ml-2 group-hover:translate-x-1 duration-300" />
              </h1>
              <h2 className="text-4xl tracking-tighter font-geist bg-clip-text text-transparent mx-auto md:text-6xl bg-[linear-gradient(180deg,_#000_0%,_rgba(0,_0,_0,_0.75)_100%)] ">
                {subtitle.regular}
            ...
            {bottomImage && <div className="mt-32 mx-10 relative z-10">
                ...
                <img src={bottomImage.dark} className="hidden w-full shadow-lg rounded-lg border border-gray-800 " alt="Dashboard preview" />
              </div>}
          </div>
        </section>
      </div>;
