    ...
    variants: {
      ...
      mode: {
        ...
        input: `
            ...
            aria-invalid:border-destructive/60 aria-invalid:ring-destructive/10             in-data-[invalid=true]:border-destructive/60 in-data-[invalid=true]:ring-destructive/10            `,
      },
      placeholder: {
