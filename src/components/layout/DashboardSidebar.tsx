...
import { Home, Users, Building2, PiggyBank, Calculator, DollarSign, FileText, TrendingUp, ChevronDown, BarChart3 } from 'lucide-react';
...
export function DashboardSidebar() {
  ...
  return <div className="w-64 flex flex-col" style={{ backgroundColor: '#f0eeef' }}>
      {/* Logo */}
