                        ...
                        <div className="flex items-center gap-2">
                          <FormControl>
                            <Input
                              ...
                              className="bg-muted border-transparent shadow-none rounded-md focus-visible:bg-background focus-visible:border-ring"
                    ...
                    <FormItem className="w-72">
                      <div className="relative w-full flex flex-col gap-1">
                        ...
                        <Select onValueChange={field.onChange} value={field.value}>
                          <FormControl>
                            <SelectTrigger size="lg" className="bg-muted border-transparent shadow-none rounded-md focus-visible:bg-background focus-visible:border-ring">
